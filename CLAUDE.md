...
- Calibration (2026-05-19): `backend/scripts/build_microstructure_weights.js`, `env_var_audit.js`, `audit_per_symbol_expectancy.js`; auto-calibration scheduler (2026-06-05): `backend/modules/microstructureAutoCalibration.js` (runs `buildModel` on a timer + writes the weights file; effective on next restart, no hot-reload; `meta.microstructureCalibration.autoRun`)
