...
const TARGET_NET_PROFIT_BPS = 20;
...
function renderText(summary) {
  ...
  lines.push('');
  lines.push('Notes:');
  lines.push('  - Closed rows assume TP_LIMIT exits at +TARGET_NET_PROFIT_BPS (20 bps net).');
...
module.exports = { reconcile, foldForensics, bucketIndex, bucketLabel, quantile, GROSS_TARGET_BPS, TARGET_NET_PROFIT_BPS };
