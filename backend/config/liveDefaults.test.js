...
withEnv({}, () => {
  ...
  assert.equal(LIVE_CRITICAL_DEFAULTS.ENTRY_UNIVERSE_MAX_SYMBOLS, '12');
  ...
  assert.equal(LIVE_CRITICAL_DEFAULTS.EXECUTION_TIER3_DEFAULT, 'false');
  ...
  assert.match(envExample, /ENTRY_UNIVERSE_MAX_SYMBOLS=12/);
