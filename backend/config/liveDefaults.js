const LIVE_CRITICAL_DEFAULTS = Object.freeze({
  ...
  QUOTE_RETRY: '2',
  ENTRY_TAKE_PROFIT_BPS: '80',
  ENTRY_STRETCH_MOVE_BPS: '100',
  ENTRY_TAKE_PROFIT_BPS_TIER1: '90',
  ENTRY_TAKE_PROFIT_BPS_TIER2: '130',
  STOP_LOSS_BPS: '25',
  MIN_PROB_TO_ENTER: '0.50',
  MIN_PROB_TO_ENTER_TIER1: '0.52',
  MIN_PROB_TO_ENTER_TIER2: '0.55',
  EXIT_NET_PROFIT_AFTER_FEES_BPS: '30',
  PROFIT_BUFFER_BPS: '15',
  EV_MIN_BPS: '10',
  ...
  ENTRY_QUOTE_MAX_AGE_MS: '30000',
  ENTRY_REGIME_STALE_QUOTE_MAX_AGE_MS: '30000',
  ...
  ORDERBOOK_SPARSE_REQUIRE_QUOTE_FRESH_MS: '10000',
  ORDERBOOK_SPARSE_STALE_QUOTE_TOLERANCE_MS: '30000',
