...
const MIN_PROB_TO_ENTER = readNumber('MIN_PROB_TO_ENTER', Number(LIVE_CRITICAL_DEFAULTS.MIN_PROB_TO_ENTER) || 0.48);
...
const MIN_PROB_TO_ENTER_TIER1 = readNumber(
  ...
  hasGlobalMinProbEnv && !hasTier1MinProbEnv ? MIN_PROB_TO_ENTER : (Number(LIVE_CRITICAL_DEFAULTS.MIN_PROB_TO_ENTER_TIER1) || 0.50),
);
const MIN_PROB_TO_ENTER_TIER2 = readNumber(
  'MIN_PROB_TO_ENTER_TIER2',
  hasGlobalMinProbEnv && !hasTier2MinProbEnv ? MIN_PROB_TO_ENTER : (Number(LIVE_CRITICAL_DEFAULTS.MIN_PROB_TO_ENTER_TIER2) || 0.52),
);
